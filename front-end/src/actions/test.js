...
const [eroorrepassword,setErrorRepasssword]=useState("")
  ...
  const dispatch = useDispatch();
   ...
   getLoc(result.data.region)
   lundi(result.data.lundi)
   lundipm(result.data.lundipm)
   mardi(result.data.lundipm)
   mardipm(result.data.lundipm)
   mercredi(result.data.lundipm)
   mercredipm(result.data.lundipm)
   jeudi(result.data.lundipm)
   jeudipm(result.data.lundipm)
   vendredi(result.data.lundipm)
   vendredipm(result.data.lundipm)
   samedi(result.data.lundipm)
   samedipm(result.data.lundipm)
   dimanche(result.data.lundipm)
   dimanchepm(result.data.lundipm)
...
const uploadVideo=(e)=>{
     ...
     console.log(video)
function ap(){
  dispatch(AddDresseurs(data._id,name,lastName,email,password,role,tel,Lat,Lng,ecole,region,fb,youtube,video,desc,file))
